...
def display_whoosh_document_schema(index_dir):
    """
    Display the schema and a sample document from a Whoosh document index.
    ...
    try:
        ...
        print("=== Whoosh Document Index Schema ===")
        print("\nField Names:")
...
def main():
    parser = argparse.ArgumentParser(description="Display schema information for a Whoosh document index")
    ...
    display_whoosh_document_schema(args.index_dir)
