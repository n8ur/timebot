...
def display_chromadb_document_metadata(collection_name, db_path):
    """
    Display the metadata layout and a sample document from a ChromaDB document collection.
    ...
    try:
        ...
        # Get collection info
        print(f"=== ChromaDB Document Collection: {collection_name} ===")
...
def main():
    parser = argparse.ArgumentParser(description="Display metadata layout for a ChromaDB document collection")
    ...
    display_chromadb_document_metadata(args.collection_name, args.db_path)
